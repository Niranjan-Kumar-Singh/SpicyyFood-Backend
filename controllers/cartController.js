...
exports.addToCart = async (req, res) => {
  ...
  try {
    ...
    const cartItemIndex = cart.items.findIndex(cartItem => cartItem.item && cartItem.item.toString() === itemId);
    ...
    await cart.save();
    await cart.populate('items.item'); // Ensure item details are populated in the response
...
exports.removeFromCart = async (req, res) => {
  ...
  try {
    ...
    cart.items = cart.items.filter(cartItem => cartItem.item && cartItem.item.toString() !== itemId);
